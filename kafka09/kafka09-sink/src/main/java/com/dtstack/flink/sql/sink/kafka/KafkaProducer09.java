 ...
 * @author maqi
 */
public class KafkaProducer09 extends FlinkKafkaProducer09<Tuple2<Boolean, Row>> {
    ...
    public KafkaProducer09(String topicId, SerializationSchema<Tuple2<Boolean, Row>> serializationSchema, Properties producerConfig,
