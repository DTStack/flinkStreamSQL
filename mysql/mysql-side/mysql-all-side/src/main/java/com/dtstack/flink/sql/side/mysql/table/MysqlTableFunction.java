...
import com.dtstack.flink.sql.side.mysql.MysqlAllReqRow;
import com.dtstack.flink.sql.side.mysql.MysqlAllSideInfo;
...
/**
 * @author: chuixue
 * @create: 2020-10-12 09:42
 * @description:
 **/
public class MysqlTableFunction extends AbstractRdbTableFunction {

    private static final Logger LOG = LoggerFactory.getLogger(MysqlAllReqRow.class);

    private static final String MYSQL_DRIVER = "com.mysql.jdbc.Driver";

    public MysqlTableFunction(AbstractSideTableInfo sideTableInfo, String[] lookupKeys) {
        super(new MysqlAllSideInfo(sideTableInfo, lookupKeys));
    }
