...
import com.dtstack.flink.sql.side.mysql.MysqlAsyncSideInfo;
...
/**
 * @author: chuixue
 * @create: 2020-10-12 19:18
 * @description:
 **/
public class MysqlAsyncTableFunction extends RdbAsyncTableFunction {
    private final static String MYSQL_DRIVER = "com.mysql.jdbc.Driver";

    public MysqlAsyncTableFunction(AbstractSideTableInfo sideTableInfo, String[] lookupKeys) {
        super(new MysqlAsyncSideInfo(sideTableInfo, lookupKeys));
    }
