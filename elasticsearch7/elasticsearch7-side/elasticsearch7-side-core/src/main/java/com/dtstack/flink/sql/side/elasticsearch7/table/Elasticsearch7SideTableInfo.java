 ...
 */
public class Elasticsearch7SideTableInfo extends AbstractSideTableInfo {
    ...
    public boolean check() {
        ...
        Preconditions.checkNotNull(clusterName, "elasticsearch7 type of clusterName is required");
