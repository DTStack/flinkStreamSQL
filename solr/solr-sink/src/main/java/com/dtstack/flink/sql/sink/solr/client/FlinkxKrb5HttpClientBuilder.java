 ...
 * @create 2021/05/18
 */
public class FlinkxKrb5HttpClientBuilder extends Krb5HttpClientBuilder {
    ...
    public FlinkxKrb5HttpClientBuilder(String principal, String keytab) {
    ...
    public SolrHttpClientBuilder getBuilder(SolrHttpClientBuilder builder) {
        if (System.getProperty(SOLR_KERBEROS_JAAS_APPNAME) != null) {
            ...
            if (configValue != null) {
                ...
                KrbUtils.appendJaasConf(configValue, keytab, principal);
