...
import com.dtstack.flink.sql.side.tidb.TidbAllSideInfo;
 ...
 * @description:
 **/
public class TidbTableFunction extends AbstractRdbTableFunction {

    private static final Logger LOG = LoggerFactory.getLogger(TidbTableFunction.class);

    private static final String TIDB_DRIVER = "com.mysql.jdbc.Driver";

    public TidbTableFunction(AbstractSideTableInfo sideTableInfo, String[] lookupKeys) {
        super(new TidbAllSideInfo(sideTableInfo, lookupKeys));
    }
