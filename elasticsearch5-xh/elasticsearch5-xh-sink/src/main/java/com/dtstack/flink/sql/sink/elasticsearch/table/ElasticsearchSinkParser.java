...
public class ElasticsearchSinkParser extends AbstractTableParser {
    ...
    public AbstractTableInfo getTableInfo(String tableName, String fieldsInfo, Map<String, Object> props) {
        ...
        //kerberos
        elasticsearchTableInfo.setKrb5conf(MathUtil.getString(props.get(PluginParamConsts.KRB5_CONF)));
        elasticsearchTableInfo.setKeytab(MathUtil.getString(props.get(PluginParamConsts.KEYTAB)));
        elasticsearchTableInfo.setPrincipal(MathUtil.getString(props.get(PluginParamConsts.PRINCIPAL)));
        elasticsearchTableInfo.judgeKrbEnable();
