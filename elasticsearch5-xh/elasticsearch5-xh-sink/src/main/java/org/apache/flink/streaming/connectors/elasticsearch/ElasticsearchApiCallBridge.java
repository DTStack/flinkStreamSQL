...
/**
 * An {@link org.apache.flink.streaming.connectors.elasticsearch.ElasticsearchApiCallBridge} is used to bridge incompatible Elasticsearch Java API calls across different versions.
...
public interface ElasticsearchApiCallBridge<C extends AutoCloseable> extends Serializable {
	...
	default RequestIndexer createBulkProcessorIndexer(
		...
		return new org.apache.flink.streaming.connectors.elasticsearch.PreElasticsearch6BulkProcessorIndexer(
			bulkProcessor,
			flushOnCheckpoint,
