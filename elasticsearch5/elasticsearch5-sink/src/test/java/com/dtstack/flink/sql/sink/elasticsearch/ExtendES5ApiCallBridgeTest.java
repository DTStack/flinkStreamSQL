 ...
 * @date 2020-06-19
 */
public class ExtendES5ApiCallBridgeTest {
    List<InetSocketAddress> addresses = Collections.singletonList(new InetSocketAddress("172.16.8.193", 9200));
    Map<String, String> clientConfig = new HashMap<>();
    ExtendES5ApiCallBridge callBridge;
    @Mock
    ...
    public void setUp() {
        ...
        callBridge = new ExtendES5ApiCallBridge(addresses, elasticsearchTableInfo);
    }
