...
//
//
//import com.dtstack.flink.sql.format.DtNestRowDeserializationSchema;
//import com.dtstack.flink.sql.format.JsonDataParser;
...
// */
//
//public class CustomerJsonDeserializationSchema extends DtNestRowDeserializationSchema<Row> {
//
//    private static final Logger LOG = LoggerFactory.getLogger(CustomerJsonDeserializationSchema.class);
//
...
//
//    public CustomerJsonDeserializationSchema(TypeInformation<Row> typeInfo, Map<String, String> rowAndFieldMapping, List<TableInfo.FieldExtraInfo> fieldExtraInfos){
