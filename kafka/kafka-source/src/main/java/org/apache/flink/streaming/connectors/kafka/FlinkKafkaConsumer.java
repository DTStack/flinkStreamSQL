...
public class FlinkKafkaConsumer<T> extends FlinkKafkaConsumerBase<T> {
    ...
    private static void setDeserializer(Properties props) {
        ...
        if (keyDeSer != null && !keyDeSer.equals(deSerName)) {
            LOG.warn("Set configured key DeSerializer ({} = {})", ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, keyDeSer);
            props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, keyDeSer.toString());
        }else{
            props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, deSerName);
        }

        if (valDeSer != null && !valDeSer.equals(deSerName)) {
            LOG.warn("Set configured value DeSerializer ({} = {})", ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, valDeSer);
            props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, valDeSer.toString());
        }else{
