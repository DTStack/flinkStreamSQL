...
public class SqlserverAllSideInfo extends SideInfo {
    ...
    public void buildEqualInfo(JoinInfo joinInfo, SideTableInfo sideTableInfo) {
        SqlserverSideTableInfo sqlserverSideTableInfo = (SqlserverSideTableInfo) sideTableInfo;

        sqlCondition = "select ${selectField} from ${tableName} ";
        sqlCondition = sqlCondition.replace("${tableName}", sqlserverSideTableInfo.getTableName()).replace("${selectField}", sideSelectFields);
