...
import com.dtstack.flink.sql.authenticate.KerberosUtil;
...
public class FileSystemUtil {
    ...
    public static FileSystem getFileSystem(Map<String, Object> hadoopConfig, String defaultFS, String jobId, String plugin) throws Exception {
        return getFileSystem(hadoopConfig, defaultFS, jobId, plugin, false);
    }

    public static FileSystem getFileSystem(Map<String, Object> hadoopConfig, String defaultFS, String jobId, String plugin, boolean skipLoadKrb5) throws Exception {
        if (openKerberos(hadoopConfig) && !skipLoadKrb5) {
