...
//    public static final String SUBJECT_ONLY_KEY = "javax.security.auth.useSubjectCredsOnly";
    ...
    public static UserGroupInformation loginAndReturnUgi(String principal, String keytabPath, String krb5confPath) throws IOException {        LOG.info("Kerberos login with principal: {} and keytab: {}", principal, keytabPath);
