 ...
 * @author tiezhu
 */
public class DamengAllSideInfo extends RdbAllSideInfo {

    public DamengAllSideInfo(RowTypeInfo rowTypeInfo, JoinInfo joinInfo, List<FieldInfo> outFieldInfoList, AbstractSideTableInfo sideTableInfo) {
