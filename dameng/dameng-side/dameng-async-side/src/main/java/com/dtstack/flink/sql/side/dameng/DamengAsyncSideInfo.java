 ...
 * @author tiezhu
 */
public class DamengAsyncSideInfo extends RdbAsyncSideInfo {
    public DamengAsyncSideInfo(RowTypeInfo rowTypeInfo, JoinInfo joinInfo, List<FieldInfo> outFieldInfoList, AbstractSideTableInfo sideTableInfo) {
