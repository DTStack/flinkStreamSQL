 ...
 * @author maqi
 */
public class KafkaProducer011 extends FlinkKafkaProducer011<CRow> {
    ...
    public KafkaProducer011(String topicId, SerializationSchema<CRow> serializationSchema, Properties producerConfig, Optional<FlinkKafkaPartitioner<CRow>> customPartitioner, String[] partitionKeys) {
