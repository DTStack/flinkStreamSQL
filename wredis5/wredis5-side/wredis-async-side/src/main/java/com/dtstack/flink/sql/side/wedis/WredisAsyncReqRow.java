...
package com.dtstack.flink.sql.side.wedis;
...
public class WredisAsyncReqRow extends AsyncReqRow {
    ...
    private WredisSideTableInfo redisSideTableInfo;


    public WredisAsyncReqRow(RowTypeInfo rowTypeInfo, JoinInfo joinInfo, List<FieldInfo> outFieldInfoList, SideTableInfo sideTableInfo) {
        super(new WredisAsyncSideInfo(rowTypeInfo, joinInfo, outFieldInfoList, sideTableInfo));
    }

    @Override
    public void open(Configuration parameters) throws Exception {
        super.open(parameters);
        redisSideTableInfo = (WredisSideTableInfo) sideInfo.getSideTableInfo();
