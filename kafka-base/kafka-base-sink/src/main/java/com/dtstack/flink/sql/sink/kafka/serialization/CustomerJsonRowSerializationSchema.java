...
public class CustomerJsonRowSerializationSchema implements SerializationSchema<Row> {
    ...
    private final CustomerJsonRowSerializationSchema.SerializationRuntimeConverter runtimeConverter;
    ...
    /**
     * @deprecated Use the provided {@link JsonRowSerializationSchema.Builder} instead.
     */
    @Deprecated
    ...
    public static class Builder {
        ...
        public CustomerJsonRowSerializationSchema build() {
            return new CustomerJsonRowSerializationSchema(typeInfo);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        final CustomerJsonRowSerializationSchema that = (CustomerJsonRowSerializationSchema) o;
    ...
    private CustomerJsonRowSerializationSchema.SerializationRuntimeConverter createConverter(TypeInformation<?> typeInfo) {
        CustomerJsonRowSerializationSchema.SerializationRuntimeConverter baseConverter = createConverterForSimpleType(typeInfo)
                .orElseGet(() ->
    ...
    private CustomerJsonRowSerializationSchema.SerializationRuntimeConverter wrapIntoNullableConverter(CustomerJsonRowSerializationSchema.SerializationRuntimeConverter converter) {
    ...
    private Optional<CustomerJsonRowSerializationSchema.SerializationRuntimeConverter> createContainerConverter(TypeInformation<?> typeInfo) {
    ...
    private CustomerJsonRowSerializationSchema.SerializationRuntimeConverter createObjectArrayConverter(TypeInformation elementTypeInfo) {
        CustomerJsonRowSerializationSchema.SerializationRuntimeConverter elementConverter = createConverter(elementTypeInfo);
        return assembleArrayConverter(elementConverter);
    }

    private CustomerJsonRowSerializationSchema.SerializationRuntimeConverter createRowConverter(RowTypeInfo typeInfo) {
        List<CustomerJsonRowSerializationSchema.SerializationRuntimeConverter> fieldConverters = Arrays.stream(typeInfo.getFieldTypes())
    ...
    private CustomerJsonRowSerializationSchema.SerializationRuntimeConverter createFallbackConverter() {
        return (mapper, reuse, object) -> {
    ...
    private Optional<CustomerJsonRowSerializationSchema.SerializationRuntimeConverter> createConverterForSimpleType(TypeInformation<?> simpleTypeInfo) {
    ...
    private CustomerJsonRowSerializationSchema.SerializationRuntimeConverter createDateConverter() {
        return (mapper, reuse, object) -> {
    ...
    private CustomerJsonRowSerializationSchema.SerializationRuntimeConverter createTimestampConverter() {
        return (mapper, reuse, object) -> {
    ...
    private CustomerJsonRowSerializationSchema.SerializationRuntimeConverter createTimeConverter() {
        return (mapper, reuse, object) -> {
    ...
    private CustomerJsonRowSerializationSchema.SerializationRuntimeConverter createBigDecimalConverter() {
        return (mapper, reuse, object) -> {
    ...
    private CustomerJsonRowSerializationSchema.SerializationRuntimeConverter createBigIntegerConverter() {
        return (mapper, reuse, object) -> {
            // convert decimal if necessary
            JsonNodeFactory nodeFactory = mapper.getNodeFactory();
    ...
    private CustomerJsonRowSerializationSchema.SerializationRuntimeConverter assembleRowConverter(
            String[] fieldNames,
            List<CustomerJsonRowSerializationSchema.SerializationRuntimeConverter> fieldConverters) {
        return (mapper, reuse, object) -> {
            ObjectNode node;
    ...
    private CustomerJsonRowSerializationSchema.SerializationRuntimeConverter assembleArrayConverter(CustomerJsonRowSerializationSchema.SerializationRuntimeConverter elementConverter) {
        return (mapper, reuse, object) -> {
            ArrayNode node;
