...
public class MetricElasticsearch6SinkTest {
    ...
    public void setUp() {
        ...
        try {
            sink = new MetricElasticsearch6Sink(userConfig, addresses, elasticsearchSinkFunction, elasticsearchTableInfo);
