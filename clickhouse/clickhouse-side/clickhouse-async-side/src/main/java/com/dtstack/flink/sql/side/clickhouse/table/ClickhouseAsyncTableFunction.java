...
import com.dtstack.flink.sql.side.clickhouse.ClickhouseAsyncSideInfo;
...
/**
 * @author: chuixue
 * @create: 2020-10-27 14:42
 * @description:
 **/
public class ClickhouseAsyncTableFunction extends RdbAsyncTableFunction {
    private static final String CLICKHOUSE_DRIVER = "ru.yandex.clickhouse.ClickHouseDriver";

    public ClickhouseAsyncTableFunction(AbstractSideTableInfo sideTableInfo, String[] lookupKeys) {
        super(new ClickhouseAsyncSideInfo(sideTableInfo, lookupKeys));
    }
