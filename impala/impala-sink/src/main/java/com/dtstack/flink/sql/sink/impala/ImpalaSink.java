...
public class ImpalaSink implements RetractStreamTableSink<Row>, IStreamSinkGener<ImpalaSink> {
    ...
    public void consumeDataStream(DataStream<Tuple2<Boolean, Row>> dataStream) {
        ImpalaOutputFormat outputFormat = buildImpalaOutputFormat();
        RichSinkFunction<Tuple2<Boolean, Row>> richSinkFunction = new OutputFormatSinkFunction(outputFormat);
