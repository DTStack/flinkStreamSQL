...
import com.dtstack.flink.sql.side.oceanbase.OceanbaseAsyncSideInfo;
...
/**
 * @author: chuixue
 * @create: 2020-10-27 14:59
 * @description:
 **/
public class OceanbaseAsyncTableFunction extends RdbAsyncTableFunction {

    private static final String OCEAN_BASE_DRIVER = "com.mysql.jdbc.Driver";

    public OceanbaseAsyncTableFunction(AbstractSideTableInfo sideTableInfo, String[] lookupKeys) {
        super(new OceanbaseAsyncSideInfo(sideTableInfo, lookupKeys));
    }
    ...
    public void open(FunctionContext context) throws Exception {
        ...
        oceanbaseClientConfig.put("url", rdbSideTableInfo.getUrl())
                .put("driver_class", OCEAN_BASE_DRIVER)
