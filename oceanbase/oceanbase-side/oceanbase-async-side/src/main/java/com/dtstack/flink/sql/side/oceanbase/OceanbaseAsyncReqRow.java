...
public class OceanbaseAsyncReqRow extends RdbAsyncReqRow {

    private static final Logger LOG = LoggerFactory.getLogger(OceanbaseAsyncReqRow.class);

    private final static String OCEANBASE_DRIVER = "com.mysql.jdbc.Driver";

    public OceanbaseAsyncReqRow(RowTypeInfo rowTypeInfo, JoinInfo joinInfo, List<FieldInfo> outFieldInfoList, SideTableInfo sideTableInfo) {
        super(new OceanbaseAsyncSideInfo(rowTypeInfo, joinInfo, outFieldInfoList, sideTableInfo));
    }
    @Override
    public void open(Configuration parameters) throws Exception {
        ...
        oceanbaseClientConfig.put("url", rdbSideTableInfo.getUrl())
                .put("driver_class", OCEANBASE_DRIVER)
