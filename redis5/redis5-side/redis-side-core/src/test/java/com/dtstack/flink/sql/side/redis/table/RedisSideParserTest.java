 ...
 * @description:
 **/
public class RedisSideParserTest {
    ...
    public void testGetTableInfo() {
        ...
        RedisSideParser parser = new RedisSideParser();
        parser.getTableInfo("Mykafka", "   mid  int ,   mbb varchar,   sid varchar,   sbb varchar , PRIMARY  KEY  (mid)", props);
