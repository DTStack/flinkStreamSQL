...
import com.dtstack.flink.sql.side.sqlserver.SqlserverAsyncSideInfo;
 ...
 * @description:
 **/
public class SqlserverAsyncTableFunction extends RdbAsyncTableFunction {
    private static final String ORACLE_DRIVER = "oracle.jdbc.driver.OracleDriver";

    public SqlserverAsyncTableFunction(AbstractSideTableInfo sideTableInfo, String[] lookupKeys) {
        super(new SqlserverAsyncSideInfo(sideTableInfo, lookupKeys));
    }
